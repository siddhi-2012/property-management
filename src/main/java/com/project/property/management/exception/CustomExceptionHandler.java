package com.project.property.management.exception;
   ...
   public ResponseEntity<List<ErrorModel>> handleFieldValidation(MethodArgumentNotValidException manv){
    ...
    public ResponseEntity<List<ErrorModel>>  handleBusinessException(BusinessException bex){
       ...
       for(ErrorModel em:bex.getErrors()){
           ...
           logger.info("Business Exception is thrown - level-warn: {} - {}",em.getCode(),em.getMessage());
           logger.info("Business Exception is thrown - level-error: {} - {}",em.getCode(),em.getMessage());
       }
